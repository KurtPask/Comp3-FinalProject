...
# -- get parameters --
index = sys.argv[1] # index == first command line argument
...
p_filters = row_params['num_filters'] # defines number of convolution layers to include in the first convolutional layer
p_dataset = row_params['dataset'] # get datasets, 1=MNIST, 2=SVHN, 3=CIFAR
